...
export default function HeaderSearchBox() {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-4 backdrop-blur-md 
        rounded-2xl px-4 sm:px-6 py-2 w-full max-w-3xl transition-all duration-300">
            ...
            <div className="flex flex-col w-full sm:w-1/2">
                <div className="relative">
                    <select
                        ...
                        className="w-full appearance-none rounded-md border border-gray-200 bg-white px-2 py-2.5
                ...
                {discipline === "__custom__" && (
                    <input
                        ...
                        className="mt-2 w-full border border-gray-200 rounded-md px-2 py-2.5 text-sm text-gray-700 
