...
export default function UniversityAbout({ uni }) {
    // Always show all stats (default to 0)
    const stats = [
        {
            label: "Scholarships",
        ...
        // {
        //     label: "Students",
        //     value: uni.studentsCount ?? 0,
        //     icon: Users,
        // },
        // {
        //     label: "Teachers",
        //     value: uni.teachersCount ?? 0,
        //     icon: BookOpen,
        // },
        {
            label: "Articles",
            value: uni.articlesCount ?? uni.articles?.length ?? 0,  // ✅ fallback added
            icon: FileText,
        },
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base whitespace-pre-line">
                    {uni.about?.trim() ||
                        ...
                        "This university hasn’t added its about section yet."}
                </p>
            </div>
        </section>
    );
